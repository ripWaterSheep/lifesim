...
import lifesim.main.game.ecs.entities.player.inventory.Inventory;
import lifesim.main.game.ecs.entities.player.inventory.InventoryItem;
...
public final class Player extends Entity {
    ...
    public void goToWorld(String worldName) {
        for (World world: Game.getSession().getAllWorlds()) {
