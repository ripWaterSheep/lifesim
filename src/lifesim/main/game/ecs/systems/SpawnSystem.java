...
import lifesim.main.game.ecs.components.AIComponent;
import lifesim.main.game.ecs.components.PositionComponent;
import lifesim.main.game.ecs.components.ProjectileComponent;
import lifesim.main.game.ecs.components.SpawnerComponent;
import lifesim.main.game.ecs.entities.Entity;
import lifesim.main.game.setting.World;


import static lifesim.main.util.Geometry.*;
    ...
    private void doSpawning(Entity entity) {
        for (PositionComponent pos: entity.getAll(PositionComponent.class)) {
            for (SpawnerComponent spawner : entity.getAll(SpawnerComponent.class)) {
                ...
                double distanceFromPlayer = getDistanceBetween(Game.getSession().getPlayer().getPos(), pos);
