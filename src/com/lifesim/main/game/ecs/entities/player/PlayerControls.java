...
import com.lifesim.main.game.controls.KeyInputListener;
...
import com.lifesim.main.util.Geometry;

import java.awt.*;

import static com.lifesim.main.game.controls.KeyInputManager.*;
import static java.lang.Math.sqrt;
import static com.lifesim.main.util.MyMath.scale;
...
public class PlayerControls {
    ...
    private void weaponControls() {
        if (MouseInputManager.right.isClicked()) {
            ...
            double angle = Geometry.getAngleBetween(MouseInputManager.right.getX(), MouseInputManager.right.getY(), com.lifesim.main.Main.getPanel().getMidWidth(), com.lifesim.main.Main.getPanel().getMidHeight());
